...
launcher = 'none'
load_from = 'work_dirs_exp/mvxnet_sqeezenet_bifpn_fire_rpf_pretrain/epoch_5.pth'
log_level = 'INFO'
...
train_cfg = dict(max_epochs=7, type='EpochBasedTrainLoop', val_interval=1)
...
work_dir = 'work_dirs_exp/mvxnet_sqeezenet_bifpn_fire_rpf_pretrain'
