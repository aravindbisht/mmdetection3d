...
model = dict(
    ...
    pts_fusion_layer=dict(
        ...
        pts_channels=64,   # Match voxel encoder output channels
        mid_channels=64,   # Intermediate channels for feature processing
        out_channels=64,   # Output channels after fusion
